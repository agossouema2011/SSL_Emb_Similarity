...
#annot_link_for_training="datasets/coco/annotations/coco_training_e_new.json"  # link to the dataset labeled or pseudo labeled training set annotation
...
def main(args):
    ...
    register_coco_instances("my_dataset_val", {}, "datasets/coco/annotations/set9_coco_validation.json", "datasets/coco/valsets/set9") # register the custom dataset
