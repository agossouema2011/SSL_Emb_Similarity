...
def generate_pick_merge_random(random_file, random_percent, indicator_file, pick_percent, save_file, static_file, reverse=True):
    ...
    # create a new datasets/coco/annotations/coco_training_c_2_new.json
    ...
    with open("datasets/coco/annotations/coco_training_c_2_new.json", "w") as data2:
    ...
    with open('datasets/coco/annotations/coco_training_c_2_new.json') as f:
    ...
    with open("datasets/coco/annotations/coco_training_c_2_new.json",'w') as f:
